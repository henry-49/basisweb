...
<div class="col-lg-12">
    <div class="card card-default">
            ...
            <div class="card-body">
                 <form action="{{ url('update/contact/'.$admincontact->id) }}" method="POST"> 
                        @csrf
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Contact Email</label>
                        <input type="email" name="email" class="form-control" id="exampleFormControlInput1"
                         placeholder="Enter Email" value="{{ $admincontact->email }}">
                    ...
                    <div class="form-group">
                        ...
                        placeholder="Enter Phone" value="{{ $admincontact->phone }}">
                    </div>
